...
# CUDA_VISIBLE_DEVICES=3 python /nfs4/wangyb/projects/OFAKD/train.py /nfs4/wangyb/projects/OFAKD/data/tiny-imagenet-200 --config /nfs4/wangyb/projects/OFAKD/configs/tiny_imagenet/dot/ofa.yaml --model resnet18 --teacher dinov2s_finetuehead --teacher-pretrained /nfs4/wangyb/projects/OFAKD/teacher_checkpoint/dinov2_tiny_imagenet_head_best.pth -d tiny-imagenet-200 --num-classes 200 --distiller ofa --ofa-eps 1.0
...
class OFA(BaseDistiller):
    ...
    def __init__(self, student, teacher, criterion, args, **kwargs):
        ...
        self.student = self.student.module if hasattr(self.student, "module") else self.student
